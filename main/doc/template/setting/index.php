	...
	<div id="body">
		<div class="menu_left">	
			...
			<ul class='setting'>
				...
				<?php echo ($public_not_admin = $GLOBALS['is_root']) ? "<li id='member'><i class='font-icon icon-group'></i>" . $L['setting_member'] . "</li>" :"" ?> 
				<!-- <li id="member"><i class="font-icon icon-group"></i><?php echo $L['setting_member'];?></li> WD -->
				<li id="theme"><i class="font-icon icon-dashboard"></i><?php echo $L['setting_theme'];?></li>
				<?php echo $public_not_admin ? "<li id='wall'><i class='font-icon icon-picture'></i>" . $L['setting_wall'] . "</li>" :"" ?> 
				<!-- <li id="wall"><i class="font-icon icon-picture"></i><?php echo $L['setting_wall'];?></li> WD -->
				<li id="fav"><i class="font-icon icon-star"></i><?php echo $L['setting_fav'];?></li>
				<?php echo $public_not_admin ? "<li id='player'><i class='font-icon icon-music'></i>" . $L['setting_player'] . "</li>" :"" ?> 
				<!-- <li id="player"><i class="font-icon icon-music"></i><?php echo $L['setting_player'];?></li>	WD -->
...
<script type="text/javascript">
	...
	seajs.use('_dev/src/setting/main');
</script>
</body>
</html>