			...
			<div class="frame-right-main">
				<div class="tools">
					<div class="tools-left">
						<div class="btn-group btn-group-sm" >
					        <button id='newfolder' class="btn btn-default" type="button" <?php echo ( $hidden =  ($public_not_admin = !$GLOBALS['is_root']) ? 'style="display: none;"' : '')?>>
					        	<i class="font-icon icon-folder-close-alt"></i><?php echo $L['newfolder'];?>
					        </button>
					        <button id='newfile' class="btn btn-default" type="button" <?php echo $hidden?>>
					        	<i class="font-icon icon-file-alt"></i><?php echo $L['newfile'];?>
					        </button>
					        <button id='upload' class="btn btn-default" type="button" <?php echo $hidden?>>
					        	<i class="font-icon icon-cloud-upload"></i><?php echo $L['upload'];?>
					        </button>

					        <div class="btn-group btn-group-sm" <?php echo $hidden?>>
						    <button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown" <?php echo $public_not_admin ?'style="width:110px"':'' ?>>
						    ...
						    <ul class="dropdown-menu pull-right drop-menu-action fadein" >
							 ...
							 <!--   <li class="divider"></li> -->
							    ...
							    <!--   <li class="divider"></li> -->
							    <li id="info" <?php echo $hidden?>><a href='javascript:;'>			    
...
<script type="text/javascript">
	...
	var G = {
		...
		role        : "<?php echo $_SESSION['kod_user']['role'];?>",
		static_path : "<?php echo STATIC_PATH;?>",
		basic_path  : "<?php echo BASIC_PATH;?>",
		data_path  : "<?php echo DATA_PATH;?>",
		...
		public_not_admin: "<?php echo $public_not_admin?>",
