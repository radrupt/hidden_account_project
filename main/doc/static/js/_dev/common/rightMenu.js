...
//            "sep1":"--------",
            ...
            "sortBy": {
                ...
                icon:"sort",
                items:{
                    "set_sort_index":{name:LNG.num,className:'menu_set_sort set_sort_num'},
                    "set_sort_name":{name:LNG.name,className:'menu_set_sort set_sort_name'},
                    "set_sort_author":{name:LNG.paper_author,className:'menu_set_sort set_sort_author'},
...
//		            "info":{name:LNG.info,className:"info",icon:"info",accesskey: "i"}
    ...
    var _bindFile = function(){
        ...
        _items = G.public_not_admin ? (G.role == "guest") ? {//为了让游客无法下载文件，但是pdf文件新页面打开的话，无法屏蔽右键，所以只能保证游客所打开页面在本页面里
            "open":{name:LNG.open,className:"open",icon:"external-link",accesskey: "o"}
//WD           "open_text":{name:LNG.edit,className:"open_text",icon:"edit",accesskey: "e"},
//WD            "open_ie":{name:LNG.open_ie,className:"open_ie",icon:"globe",accesskey: "b"},
            // "newfileOther":{                    
            //     name:LNG.open_with,
            //     accesskey:'h',
            //     items:{
            ...
            "open_ie":{name:LNG.open,className:"open",icon:"external-link",accesskey: "o"},
//WS            "open_text":{name:LNG.edit,className:"open_text",icon:"edit",accesskey: "e"},
//WD            "open_ie":{name:LNG.open_ie,className:"open_ie",icon:"globe",accesskey: "b"},
            // "newfileOther":{                    
            //     name:LNG.open_with,
            //     accesskey:'h',
...
//WD            "open_ie":{name:LNG.open_ie,className:"open_ie",icon:"globe",accesskey: "b"},
    ...
    var _menuBody = function(action) {
        switch(action){
            ...
            case 'set_sort_index':ui.setListSort('index',0);break;//排序方式，编号
            case 'set_sort_name':ui.setListSort('name',0);break;//排序方式，名称
            case 'set_sort_author':ui.setListSort('author',0);break;//排序方式，作者
