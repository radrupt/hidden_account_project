define(function(require, exports) {
	...
	var _open = function(path,ext){
		...
		if (ext == 'pdf') {
			...
			<p target="_blank" style="display:block;margin:0 auto;margin-top:80px;font-size:16px;text-align:center;">'+LNG.error+'   '+"暂不支持当前浏览器，请使用谷歌，搜狗，opera浏览器"+' </p></div>';
//WD			<a href="'+url+'" target="_blank" style="display:block;margin:0 auto;margin-top:80px;font-size:16px;text-align:center;">'+LNG.error+'   '+LNG.download+' PDF</a></div>';
			$.dialog({
				resize:true,
				fixed:true,
				ico:core.ico('pdf'),
