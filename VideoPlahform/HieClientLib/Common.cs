    ...
    public class Common
    {
        ...
        */
        ...
        public struct DeviceProbeConfig
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAC_BINARY_ADDRESS_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] m_bytDevMac;		                        /*!< 设备MAC地址(Read)						*/
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = IP_ADDRESS_LEN, ArraySubType = UnmanagedType.I1)]
        ...
        */
        [UnmanagedFunctionPointerAttribute(CallingConvention.StdCall)]
        public delegate int CB_DeviceProbe(ref DeviceProbeConfig cConfig);
