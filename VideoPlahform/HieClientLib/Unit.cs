...
namespace HieCiULib
{
    public class Unit
    {
        ...
        *	接口类型: 阻塞式
        */
        [DllImport("HieClientUnit.dll", EntryPoint = "HieClient_DeviceProbeStart", CharSet = CharSet.Ansi)]
        public static extern int HieClient_DeviceProbeStart(ref Common.DeviceProbeParameter cParameter, Common.CB_DeviceProbe cbDeviceProbe);
        ...
        */
        ...
        public static extern int HieClient_DeviceProbeSetDeviceConfig(ref byte[] pMac, int wProbePort, ref Common.DeviceProbeConfig cConfig);
