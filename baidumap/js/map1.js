    ...
    this.draw = function(){
        ...
        computeSenderAndReceiverPOI(info, function(senderP, receiverP) {
            ...
            var senderinfoBox = new InfoBox(map, 2, {company: dd.sender_company,
                ...
                dd.sender_address), namemobile: dd.sender_name+"  "+dd.sender_mobile, startorend: 0})//start
            var receiverinfoBox = new InfoBox(map, 2, {company: dd.receiver_company,
                ...
                dd.receiver_address), namemobile: dd.receiver_name+"  "+dd.receiver_mobile, startorend: 0})//start
            ...
            if( info.status != "运输中" ) {
                info.waybill.forEach(function (waybill) {
                    ...
                    geoc.getLocation(point, function(rs){
                        ...
                        truckinfoBox = new InfoBox(map, 0, {placeinfo: addressinfo, updatetime: waybill.location.time});
                    });
                    driving.search(senderP, point, {waypoints: points});
                })
            }

            drawIcon(map, senderP, "./images/ico/sender.png", senderinfoBox);
            drawIcon(map, receiverP, "./images/ico/receiver.png", receiverinfoBox);
...
LeftControl.prototype.initialize = function (map) {
    ...
    var Tab = function (infos) {
        ...
        this.makeContent = function () {
            this.ordercontent = '<div>' + getOrderContent(infos) + '</div>';
            this.truckcontent = getTruckContent(infos);
        ...
        function getTruckContent(infos) {
            //daixie................
            //运单收集
            var waybilllist = infos[0].waybill;
            var addb = '';
...
function loadLkMap(infos, container){
    ...
    var drawRoute = new DrawRoute(map, infos[0]);
    drawRoute.draw();
}
...
//src:图标对应的图片
function drawIcon(map, point, src,  infobox){
        ...
        maker.addEventListener("mouseover", function(e){console.log(e.point);
...
InfoBox.prototype.htmltem0 = function(placeinfo, updatetime){
    return '<div class="infoboxcss1">'+placeinfo+updatetime+'</div>';
}
...
InfoBox.prototype.htmltem2 = function(company, placeinfo, namemobile, senderorrecevier){
    if( senderorrecevier == 0 ) imgsrc = "./images/ico/sender.png";
    else imgsrc = "./images/ico/recevier.png";;
    return '<div class="infoboxcss3" id="infobox3"><img src="' + imgsrc + '"/>'+ company+placeinfo+namemobile+'</div>';
}
